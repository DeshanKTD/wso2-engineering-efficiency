...
/*
 * servlet for adding the version
 */
public class AddVersion extends HttpServlet {
    private static final Logger logger = Logger.getLogger(AddVersion.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        String backResponse = httpHandler.post(this.baseUrl + "/products/versions/add", requestBody);
