 ...
 */
public class VersionAdder extends HttpServlet {
    private static final Logger logger = Logger.getLogger(VersionAdder.class);

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        HttpHandler httpHandler = new HttpHandler();
        String requestBody = RequestHelper.getRequestBody(request);
        String backResponse = httpHandler.post("/products/versions/add", requestBody);
