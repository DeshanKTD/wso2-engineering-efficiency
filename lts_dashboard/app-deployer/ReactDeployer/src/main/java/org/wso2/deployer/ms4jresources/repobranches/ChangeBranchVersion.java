...
/*
 * servlet to change branch version
 */
public class ChangeBranchVersion extends HttpServlet {
    private static final Logger logger = Logger.getLogger(ChangeBranchVersion.class);
    private String baseUrl = null;

    public ChangeBranchVersion() {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        String backResponse = httpHandler.post(this.baseUrl + "/branches/changeVersion", requestBody);
