 ...
 */
public class BranchVersionChanger extends HttpServlet {
    private static final Logger logger = Logger.getLogger(BranchVersionChanger.class);

    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        HttpHandler httpHandler = new HttpHandler();
        String requestBody = RequestHelper.getRequestBody(request);
        String backResponse = httpHandler.post("/branches/changeVersion", requestBody);
