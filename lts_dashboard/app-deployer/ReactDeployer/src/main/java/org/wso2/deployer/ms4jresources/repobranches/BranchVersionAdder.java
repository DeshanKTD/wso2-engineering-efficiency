...
/*
 * servlet to add version for a branch
 */
public class BranchVersionAdder extends HttpServlet {
    private static final Logger logger = Logger.getLogger(BranchVersionAdder.class);
